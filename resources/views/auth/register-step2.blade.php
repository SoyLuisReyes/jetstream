    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register-step2.post') }}" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <select name="city_id" id="" class="block mt-1 w-full class' => 'border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
